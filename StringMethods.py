...
# triple single and double quotes are used for multiple lines
myStringFive = """First
Second 'Test' \ "Test"
Third"""
...
a = "    I Love Python    "
print(a.strip())  # strip white space from right and left
print(a.rstrip())
print(a.lstrip())
...
b = "I Love 2d Graphics and 3g Technology and python"  # first letter of each word is capital & and any letter after a number is also capital
print(b.title())
...
# center(arg1,arg2) arg1: total number of letters , arg2: the character you wanna fill with
...
print(f.count("PHP", 0, 25))  # Only One PHP Word from index 0 to index 25

...
i = {"A", True, 1, 2, 3, 4, 5}
print(i.pop())  # pop ay 7aga as I can't use indexing in sets
...
print(c) # update the original set
...
print(g)  # update the original set

print("=" * 40)  # Separator

# symmetric_difference()  => not intersection
...
print(k) # update the original set
